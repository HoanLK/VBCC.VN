(function (app) {
    ...
    function listPostController($scope, $http, $window, ArrayService, CommonService, DevExtremeService, StringService, CategoryPostService, postService) {
        ...
        //     key: "Id",
        //     loadUrl: "odata/PostsAPI"
        // });
        $scope.gridPosts.dataSource = {
            store: {
                type: "odata",
                url: "http://localhost:49942/odata/PostsAPI?$select=Alias,CategoryId,Featured,Id,Published,Title,TimeCreated,Views"
            }
        };
