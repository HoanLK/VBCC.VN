(function (app) {
    ...
    app.controller('infoCompanyController', infoCompanyController);

    infoCompanyController.$inject = ['$scope', '$http', '$window', '$cookies', '$routeParams'];

    function infoCompanyController($scope, $http, $window, $cookies, $routeParams) {
